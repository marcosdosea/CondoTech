...
-- -----------------------------------------------------
-- Table `mydb`.`areaComum`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`areaComum` (
...
-- -----------------------------------------------------
-- Table `mydb`.`tarefaRecorrente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tarefaRecorrente` (
...
-- -----------------------------------------------------
-- Table `mydb`.`condominio_has_tarefaRecorrente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`condominio_has_tarefaRecorrente` (
  `condominio_id_condominio` INT NOT NULL,
  ...
  CONSTRAINT `fk_condominio_has_tarefaRecorrente_tarefaRecorrente1`
    ...
    REFERENCES `mydb`.`tarefaRecorrente` (`id_tarefaRecorrente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`pessoa_has_areaComum`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`pessoa_has_areaComum` (
  `pessoa_id_pessoa` INT NOT NULL,
  ...
  CONSTRAINT `fk_pessoa_has_areaComum_areaComum1`
    ...
    REFERENCES `mydb`.`areaComum` (`id_areaComum`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`pessoa_has_condominio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`pessoa_has_condominio` (
  `pessoa_id_pessoa` INT NOT NULL,
  `condominio_id_condominio` INT NOT NULL,
